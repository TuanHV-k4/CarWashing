            ...
            modelBuilder.Entity("DataAccessLayer.Entity.AttendanceRecord", b =>
                {
                    ...
                    b.ToTable("AttendanceRecords", null, t =>
                        {
                            t.HasCheckConstraint("CK_AttendanceRecords_WorkedMinutes", "\"WorkedMinutes\" >= 0 AND \"LateMinutes\" >= 0 AND \"EarlyLeaveMinutes\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.BehavioralLog", b =>
                {
                    ...
                    b.ToTable("BehavioralLogs", (string)null);
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.BookingPromotion", b =>
                {
                    ...
                    b.ToTable("BookingPromotions", null, t =>
                        {
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.BookingRescheduleHistory", b =>
                {
                    ...
                    b.ToTable("BookingRescheduleHistories", null, t =>
                        {
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.CustomerTierHistory", b =>
                {
                    ...
                    b.ToTable("CustomerTierHistories", null, t =>
                        {
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.LicensePlateRecognitionLog", b =>
                {
                    ...
                    b.ToTable("LicensePlateRecognitionLogs", null, t =>
                        {
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.LoyaltyPointTransaction", b =>
                {
                    ...
                    b.ToTable("LoyaltyPointTransactions", null, t =>
                        {
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.PromotionCustomer", b =>
                {
                    ...
                    b.ToTable("PromotionCustomers", null, t =>
                        {
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.WashHistory", b =>
                {
                    ...
                    b.ToTable("WashHistories", null, t =>
                        {
